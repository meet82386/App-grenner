...
class Become_a_Donater extends StatefulWidget {
  @override
  _Become_a_DonaterState createState() => _Become_a_DonaterState();
}

class _Become_a_DonaterState extends State<Become_a_Donater> {
  @override
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          indicatorWeight: 5,
          tabs: [
            Tab(icon: Icon(Icons.security_rounded), text: 'Donate Land for Trees'),
            Tab(icon: Icon(Icons.new_releases), text: 'My Donations'),
          ],
        ),
        elevation: 20,
        titleSpacing: 20,
